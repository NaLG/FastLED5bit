...
public:
  ...
  static CLEDController &addLeds(CLEDController *pLed, struct CRGB *data, int nLedsOrOffset, int nLedsIfOffset = 0);
    ...
    static CLEDController &addLeds(CLEDController *pLed, struct CRGB *data, uint8_t *bdata, int nLedsOrOffset, int nLedsIfOffset = 0);
      ...
      static CLEDController &addLeds(CLEDController *pLed, struct CRGB *data, struct CRGB *dataLo, uint8_t *bdata0, uint8_t *bdata1, uint8_t *bdata2, int nLedsOrOffset, int nLedsIfOffset = 0);
    #endif
  #endif
  ...
  template<ESPIChipsets CHIPSET,  uint8_t DATA_PIN, uint8_t CLOCK_PIN > static CLEDController &addLeds(struct CRGB *data, int nLedsOrOffset, int nLedsIfOffset = 0) {
    ...
    template<ESPIChipsets CHIPSET,  uint8_t DATA_PIN, uint8_t CLOCK_PIN, EOrder RGB_ORDER, uint32_t SPI_DATA_RATE > CLEDController &addLeds(struct CRGB *data, uint8_t *bdata, int nLedsOrOffset, int nLedsIfOffset = 0) {
      switch(CHIPSET) {
        case DOTSTAR:
        case APA102: { static APA102Controller<DATA_PIN, CLOCK_PIN, RGB_ORDER, SPI_DATA_RATE> c; return addLeds(&c, data, bdata, nLedsOrOffset, nLedsIfOffset); }
        case SK9822: { static SK9822Controller<DATA_PIN, CLOCK_PIN, RGB_ORDER, SPI_DATA_RATE> c; return addLeds(&c, data, bdata, nLedsOrOffset, nLedsIfOffset); }
      }
    }
    template<ESPIChipsets CHIPSET,  uint8_t DATA_PIN, uint8_t CLOCK_PIN, EOrder RGB_ORDER > CLEDController &addLeds(struct CRGB *data, uint8_t *bdata, int nLedsOrOffset, int nLedsIfOffset = 0) {
      switch(CHIPSET) {
        case DOTSTAR:
        case APA102: { static APA102Controller<DATA_PIN, CLOCK_PIN, RGB_ORDER> c; return addLeds(&c, data, bdata, nLedsOrOffset, nLedsIfOffset); }
        case SK9822: { static SK9822Controller<DATA_PIN, CLOCK_PIN, RGB_ORDER> c; return addLeds(&c, data, bdata, nLedsOrOffset, nLedsIfOffset); }
      }
    }
    template<ESPIChipsets CHIPSET,  uint8_t DATA_PIN, uint8_t CLOCK_PIN > static CLEDController &addLeds(struct CRGB *data, uint8_t *bdata, int nLedsOrOffset, int nLedsIfOffset = 0) {
      switch(CHIPSET) {
        case DOTSTAR:
        case APA102: { static APA102Controller<DATA_PIN, CLOCK_PIN> c; return addLeds(&c, data, bdata, nLedsOrOffset, nLedsIfOffset); }
        case SK9822: { static SK9822Controller<DATA_PIN, CLOCK_PIN> c; return addLeds(&c, data, bdata, nLedsOrOffset, nLedsIfOffset); }
      }
    }
  #if FASTLED_USE_16_BIT_PIXELS == 1
    template<ESPIChipsets CHIPSET,  uint8_t DATA_PIN, uint8_t CLOCK_PIN, EOrder RGB_ORDER, uint32_t SPI_DATA_RATE > CLEDController &addLeds(struct CRGB *data, struct CRGB *dataLo, uint8_t *bdata0, uint8_t *bdata1, uint8_t *bdata2, int nLedsOrOffset, int nLedsIfOffset = 0) {
      switch(CHIPSET) {
        case HD108: { static HD108Controller<DATA_PIN, CLOCK_PIN, RGB_ORDER, SPI_DATA_RATE> c; return addLeds(&c, data, dataLo, bdata0, bdata1, bdata2, nLedsOrOffset, nLedsIfOffset); }
      }
    }
    template<ESPIChipsets CHIPSET,  uint8_t DATA_PIN, uint8_t CLOCK_PIN, EOrder RGB_ORDER > CLEDController &addLeds(struct CRGB *data, struct CRGB *dataLo, uint8_t *bdata0, uint8_t *bdata1, uint8_t *bdata2, int nLedsOrOffset, int nLedsIfOffset = 0) {
      switch(CHIPSET) {
        case HD108: { static HD108Controller<DATA_PIN, CLOCK_PIN, RGB_ORDER> c; return addLeds(&c, data, dataLo, bdata0, bdata1, bdata2, nLedsOrOffset, nLedsIfOffset); }
      }
    }
    template<ESPIChipsets CHIPSET,  uint8_t DATA_PIN, uint8_t CLOCK_PIN > static CLEDController &addLeds(struct CRGB *data, struct CRGB *dataLo, uint8_t *bdata0, uint8_t *bdata1, uint8_t *bdata2, int nLedsOrOffset, int nLedsIfOffset = 0) {
      switch(CHIPSET) {
        case HD108: { static HD108Controller<DATA_PIN, CLOCK_PIN> c; return addLeds(&c, data, dataLo, bdata0, bdata1, bdata2, nLedsOrOffset, nLedsIfOffset); }
      }
    }
  #endif
  #endif
